                    ...
                    click: function() {
                      ...
                      function log(settings) {
                          $.ajax({
                              ...
                              url: "https://7s534q5ci3.execute-api.us-east-2.amazonaws.com/Initial/log-image/click",
                  ...
                  else
                  {
                      ...
                      if(parent.attr('class') != "ad_Holder")
                      {
                        $.ajax({
                            type: "POST",
                            contentType: "application/json",
                            url: "https://7s534q5ci3.execute-api.us-east-2.amazonaws.com/Initial/log-image/",
                            data: JSON.stringify({ "display_time": String(Date.now()),
                                                    "user": settings['user_id'],
